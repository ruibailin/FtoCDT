...
#define yyparse         tblmodparse
#define yylex           tblmodlex
#define yyerror         tblmoderror
#define yydebug         tblmoddebug
#define yynerrs         tblmodnerrs

#define yylval          tblmodlval
#define yychar          tblmodchar
#define yylloc          tblmodlloc

/* Copy the first part of user declarations.  */
#line 2 "table_mod_parse.y" /* yacc.c:339  */
...
#line 181 "table_mod_parse.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 110 "table_mod_parse.y" /* yacc.c:355  */

      double real;

#line 230 "table_mod_parse.c" /* yacc.c:355  */
};
...
#line 261 "table_mod_parse.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "END_LINE", "REAL", "$accept", "table",
  "point", "columns", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 131 "table_mod_parse.y" /* yacc.c:1646  */
    {
	      /*
...
#line 1449 "table_mod_parse.c" /* yacc.c:1646  */
    break;

  case 5:
#line 166 "table_mod_parse.y" /* yacc.c:1646  */
    {
	    if (table_def->control.info.interp[0] != IVL_IGNORE_COLUMN) {
		  values[0] = (yyvsp[0].real);
		  cur_value = 1;
	    } else cur_value = 0;
	    cur_columns = 1;
      }
#line 1461 "table_mod_parse.c" /* yacc.c:1646  */
    break;

  case 6:
#line 174 "table_mod_parse.y" /* yacc.c:1646  */
    {
	    if (cur_columns < indep_columns) {
		  if (table_def->control.info.interp[cur_columns] !=
		      IVL_IGNORE_COLUMN) {
			values[cur_value] = (yyvsp[0].real);
			cur_value += 1;
		  }
	    } else if (cur_columns == dep_column) values[indep_values] = (yyvsp[0].real);
	    cur_columns += 1;
      }
#line 1476 "table_mod_parse.c" /* yacc.c:1646  */
    break;


#line 1480 "table_mod_parse.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 186 "table_mod_parse.y" /* yacc.c:1906  */
