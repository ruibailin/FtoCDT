...
uint16_t _TRACE_BLOCK_COPY_SKIP_DSTATE;
...
uint16_t _TRACE_NBD_CLIENT_CONNECT_DSTATE;
uint16_t _TRACE_NBD_CLIENT_CONNECT_SUCCESS_DSTATE;
...
uint16_t _TRACE_FILE_XFS_WRITE_ZEROES_DSTATE;
uint16_t _TRACE_FILE_XFS_DISCARD_DSTATE;
...
uint16_t _TRACE_SHEEPDOG_RECONNECT_TO_SDOG_DSTATE;
uint16_t _TRACE_SHEEPDOG_AIO_READ_RESPONSE_DSTATE;
uint16_t _TRACE_SHEEPDOG_OPEN_DSTATE;
uint16_t _TRACE_SHEEPDOG_CLOSE_DSTATE;
uint16_t _TRACE_SHEEPDOG_CREATE_BRANCH_SNAPSHOT_DSTATE;
uint16_t _TRACE_SHEEPDOG_CREATE_BRANCH_CREATED_DSTATE;
uint16_t _TRACE_SHEEPDOG_CREATE_BRANCH_NEW_DSTATE;
uint16_t _TRACE_SHEEPDOG_CO_RW_VECTOR_UPDATE_DSTATE;
uint16_t _TRACE_SHEEPDOG_CO_RW_VECTOR_NEW_DSTATE;
uint16_t _TRACE_SHEEPDOG_SNAPSHOT_CREATE_INFO_DSTATE;
uint16_t _TRACE_SHEEPDOG_SNAPSHOT_CREATE_DSTATE;
uint16_t _TRACE_SHEEPDOG_SNAPSHOT_CREATE_INODE_DSTATE;
...
TraceEvent _TRACE_BLOCK_COPY_SKIP_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "block_copy_skip",
    .sstate = TRACE_BLOCK_COPY_SKIP_ENABLED,
    .dstate = &_TRACE_BLOCK_COPY_SKIP_DSTATE 
};
...
TraceEvent _TRACE_NBD_CLIENT_CONNECT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nbd_client_connect",
    .sstate = TRACE_NBD_CLIENT_CONNECT_ENABLED,
    .dstate = &_TRACE_NBD_CLIENT_CONNECT_DSTATE 
};
TraceEvent _TRACE_NBD_CLIENT_CONNECT_SUCCESS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nbd_client_connect_success",
    .sstate = TRACE_NBD_CLIENT_CONNECT_SUCCESS_ENABLED,
    .dstate = &_TRACE_NBD_CLIENT_CONNECT_SUCCESS_DSTATE 
};
...
TraceEvent _TRACE_FILE_XFS_WRITE_ZEROES_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "file_xfs_write_zeroes",
    .sstate = TRACE_FILE_XFS_WRITE_ZEROES_ENABLED,
    .dstate = &_TRACE_FILE_XFS_WRITE_ZEROES_DSTATE 
};
TraceEvent _TRACE_FILE_XFS_DISCARD_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "file_xfs_discard",
    .sstate = TRACE_FILE_XFS_DISCARD_ENABLED,
    .dstate = &_TRACE_FILE_XFS_DISCARD_DSTATE 
};
...
TraceEvent _TRACE_SHEEPDOG_RECONNECT_TO_SDOG_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_reconnect_to_sdog",
    .sstate = TRACE_SHEEPDOG_RECONNECT_TO_SDOG_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_RECONNECT_TO_SDOG_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_AIO_READ_RESPONSE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_aio_read_response",
    .sstate = TRACE_SHEEPDOG_AIO_READ_RESPONSE_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_AIO_READ_RESPONSE_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_OPEN_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_open",
    .sstate = TRACE_SHEEPDOG_OPEN_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_OPEN_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_CLOSE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_close",
    .sstate = TRACE_SHEEPDOG_CLOSE_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_CLOSE_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_CREATE_BRANCH_SNAPSHOT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_create_branch_snapshot",
    .sstate = TRACE_SHEEPDOG_CREATE_BRANCH_SNAPSHOT_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_CREATE_BRANCH_SNAPSHOT_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_CREATE_BRANCH_CREATED_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_create_branch_created",
    .sstate = TRACE_SHEEPDOG_CREATE_BRANCH_CREATED_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_CREATE_BRANCH_CREATED_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_CREATE_BRANCH_NEW_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_create_branch_new",
    .sstate = TRACE_SHEEPDOG_CREATE_BRANCH_NEW_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_CREATE_BRANCH_NEW_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_CO_RW_VECTOR_UPDATE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_co_rw_vector_update",
    .sstate = TRACE_SHEEPDOG_CO_RW_VECTOR_UPDATE_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_CO_RW_VECTOR_UPDATE_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_CO_RW_VECTOR_NEW_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_co_rw_vector_new",
    .sstate = TRACE_SHEEPDOG_CO_RW_VECTOR_NEW_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_CO_RW_VECTOR_NEW_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_SNAPSHOT_CREATE_INFO_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_snapshot_create_info",
    .sstate = TRACE_SHEEPDOG_SNAPSHOT_CREATE_INFO_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_SNAPSHOT_CREATE_INFO_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_SNAPSHOT_CREATE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_snapshot_create",
    .sstate = TRACE_SHEEPDOG_SNAPSHOT_CREATE_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_SNAPSHOT_CREATE_DSTATE 
};
TraceEvent _TRACE_SHEEPDOG_SNAPSHOT_CREATE_INODE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "sheepdog_snapshot_create_inode",
    .sstate = TRACE_SHEEPDOG_SNAPSHOT_CREATE_INODE_ENABLED,
    .dstate = &_TRACE_SHEEPDOG_SNAPSHOT_CREATE_INODE_DSTATE 
};
...
TraceEvent *block_trace_events[] = {
    ...
    &_TRACE_NBD_CLIENT_CONNECT_EVENT,
    &_TRACE_NBD_CLIENT_CONNECT_SUCCESS_EVENT,
    ...
    &_TRACE_FILE_XFS_WRITE_ZEROES_EVENT,
    &_TRACE_FILE_XFS_DISCARD_EVENT,
    &_TRACE_FILE_FINDEJECTABLEOPTICALMEDIA_EVENT,
    &_TRACE_FILE_SETUP_CDROM_EVENT,
    &_TRACE_FILE_HDEV_IS_SG_EVENT,
    &_TRACE_SHEEPDOG_RECONNECT_TO_SDOG_EVENT,
    &_TRACE_SHEEPDOG_AIO_READ_RESPONSE_EVENT,
    &_TRACE_SHEEPDOG_OPEN_EVENT,
    &_TRACE_SHEEPDOG_CLOSE_EVENT,
    &_TRACE_SHEEPDOG_CREATE_BRANCH_SNAPSHOT_EVENT,
    &_TRACE_SHEEPDOG_CREATE_BRANCH_CREATED_EVENT,
    &_TRACE_SHEEPDOG_CREATE_BRANCH_NEW_EVENT,
    &_TRACE_SHEEPDOG_CO_RW_VECTOR_UPDATE_EVENT,
    &_TRACE_SHEEPDOG_CO_RW_VECTOR_NEW_EVENT,
    &_TRACE_SHEEPDOG_SNAPSHOT_CREATE_INFO_EVENT,
    &_TRACE_SHEEPDOG_SNAPSHOT_CREATE_EVENT,
    &_TRACE_SHEEPDOG_SNAPSHOT_CREATE_INODE_EVENT,
