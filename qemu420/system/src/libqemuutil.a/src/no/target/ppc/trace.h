...
extern TraceEvent _TRACE_KVM_INJECTED_INTERRUPT_EVENT;
...
extern uint16_t _TRACE_KVM_INJECTED_INTERRUPT_DSTATE;
...
#define TRACE_KVM_INJECTED_INTERRUPT_ENABLED 1
...
#define TRACE_KVM_INJECTED_INTERRUPT_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_KVM_INJECTED_INTERRUPT) || \
    false)

static inline void _nocheck__trace_kvm_injected_interrupt(int irq)
{
    if (trace_event_get_state(TRACE_KVM_INJECTED_INTERRUPT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:kvm_injected_interrupt " "injected interrupt %d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , irq);
    }
...
static inline void trace_kvm_injected_interrupt(int irq)
{
    if (true) {
        _nocheck__trace_kvm_injected_interrupt(irq);
    }
}
