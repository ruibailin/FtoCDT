...
uint16_t _TRACE_SERIAL_IOPORT_READ_DSTATE;
uint16_t _TRACE_SERIAL_IOPORT_WRITE_DSTATE;
...
TraceEvent _TRACE_SERIAL_IOPORT_READ_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "serial_ioport_read",
    .sstate = TRACE_SERIAL_IOPORT_READ_ENABLED,
    .dstate = &_TRACE_SERIAL_IOPORT_READ_DSTATE 
};
TraceEvent _TRACE_SERIAL_IOPORT_WRITE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "serial_ioport_write",
    .sstate = TRACE_SERIAL_IOPORT_WRITE_ENABLED,
    .dstate = &_TRACE_SERIAL_IOPORT_WRITE_DSTATE 
};
...
TraceEvent *hw_char_trace_events[] = {
    ...
    &_TRACE_SERIAL_IOPORT_READ_EVENT,
    &_TRACE_SERIAL_IOPORT_WRITE_EVENT,
