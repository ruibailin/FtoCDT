...
uint16_t _TRACE_TSC2005_SENSE_DSTATE;
...
TraceEvent _TRACE_TSC2005_SENSE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "tsc2005_sense",
    .sstate = TRACE_TSC2005_SENSE_ENABLED,
    .dstate = &_TRACE_TSC2005_SENSE_DSTATE 
};
