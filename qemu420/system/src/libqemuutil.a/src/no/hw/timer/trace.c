...
uint16_t _TRACE_BCM2835_SYSTMR_IRQ_DSTATE;
...
TraceEvent _TRACE_BCM2835_SYSTMR_IRQ_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "bcm2835_systmr_irq",
    .sstate = TRACE_BCM2835_SYSTMR_IRQ_ENABLED,
    .dstate = &_TRACE_BCM2835_SYSTMR_IRQ_DSTATE 
};
...
TraceEvent *hw_timer_trace_events[] = {
    ...
    &_TRACE_BCM2835_SYSTMR_IRQ_EVENT,
