...
{
    if (trace_event_get_state(TRACE_SPAPR_CAS_FAILED) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:spapr_cas_failed " "DT diff buffer is too small: %ld bytes" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , n);
    }
...
{
    if (trace_event_get_state(TRACE_PREP_IO_800_WRITEB) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:prep_io_800_writeb " "0x%08" PRIx32 " => 0x%02" PRIx32 "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , addr, val);
    }
...
{
    if (trace_event_get_state(TRACE_PREP_IO_800_READB) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:prep_io_800_readb " "0x%08" PRIx32 " <= 0x%02" PRIx32 "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , addr, retval);
    }
