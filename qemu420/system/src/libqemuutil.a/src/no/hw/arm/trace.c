...
uint16_t _TRACE_SMMUV3_CMDQ_TLBI_NH_VA_DSTATE;
uint16_t _TRACE_SMMUV3_CMDQ_TLBI_NH_VAA_DSTATE;
uint16_t _TRACE_SMMUV3_CMDQ_TLBI_NH_DSTATE;
uint16_t _TRACE_SMMUV3_CMDQ_TLBI_NH_ASID_DSTATE;
uint16_t _TRACE_SMMU_IOTLB_CACHE_HIT_DSTATE;
uint16_t _TRACE_SMMU_IOTLB_CACHE_MISS_DSTATE;
...
TraceEvent _TRACE_SMMUV3_CMDQ_TLBI_NH_VA_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmuv3_cmdq_tlbi_nh_va",
    .sstate = TRACE_SMMUV3_CMDQ_TLBI_NH_VA_ENABLED,
    .dstate = &_TRACE_SMMUV3_CMDQ_TLBI_NH_VA_DSTATE 
};
TraceEvent _TRACE_SMMUV3_CMDQ_TLBI_NH_VAA_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmuv3_cmdq_tlbi_nh_vaa",
    .sstate = TRACE_SMMUV3_CMDQ_TLBI_NH_VAA_ENABLED,
    .dstate = &_TRACE_SMMUV3_CMDQ_TLBI_NH_VAA_DSTATE 
};
...
TraceEvent _TRACE_SMMU_IOTLB_CACHE_HIT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmu_iotlb_cache_hit",
    .sstate = TRACE_SMMU_IOTLB_CACHE_HIT_ENABLED,
    .dstate = &_TRACE_SMMU_IOTLB_CACHE_HIT_DSTATE 
};
TraceEvent _TRACE_SMMU_IOTLB_CACHE_MISS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "smmu_iotlb_cache_miss",
    .sstate = TRACE_SMMU_IOTLB_CACHE_MISS_ENABLED,
    .dstate = &_TRACE_SMMU_IOTLB_CACHE_MISS_DSTATE 
};
...
TraceEvent *hw_arm_trace_events[] = {
    ...
    &_TRACE_SMMUV3_CMDQ_TLBI_NH_VA_EVENT,
    &_TRACE_SMMUV3_CMDQ_TLBI_NH_VAA_EVENT,
    &_TRACE_SMMUV3_CMDQ_TLBI_NH_EVENT,
    &_TRACE_SMMUV3_CMDQ_TLBI_NH_ASID_EVENT,
    &_TRACE_SMMU_IOTLB_CACHE_HIT_EVENT,
    &_TRACE_SMMU_IOTLB_CACHE_MISS_EVENT,
