...
uint16_t _TRACE_VFIO_PCI_NVIDIA_GPU_SETUP_QUIRK_DSTATE;
uint16_t _TRACE_VFIO_PCI_NVLINK2_SETUP_QUIRK_SSATGT_DSTATE;
uint16_t _TRACE_VFIO_PCI_NVLINK2_SETUP_QUIRK_LNKSPD_DSTATE;
...
uint16_t _TRACE_VFIO_DMA_UNMAP_OVERFLOW_WORKAROUND_DSTATE;
...
TraceEvent _TRACE_VFIO_PCI_NVIDIA_GPU_SETUP_QUIRK_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "vfio_pci_nvidia_gpu_setup_quirk",
    .sstate = TRACE_VFIO_PCI_NVIDIA_GPU_SETUP_QUIRK_ENABLED,
    .dstate = &_TRACE_VFIO_PCI_NVIDIA_GPU_SETUP_QUIRK_DSTATE 
};
TraceEvent _TRACE_VFIO_PCI_NVLINK2_SETUP_QUIRK_SSATGT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "vfio_pci_nvlink2_setup_quirk_ssatgt",
    .sstate = TRACE_VFIO_PCI_NVLINK2_SETUP_QUIRK_SSATGT_ENABLED,
    .dstate = &_TRACE_VFIO_PCI_NVLINK2_SETUP_QUIRK_SSATGT_DSTATE 
};
TraceEvent _TRACE_VFIO_PCI_NVLINK2_SETUP_QUIRK_LNKSPD_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "vfio_pci_nvlink2_setup_quirk_lnkspd",
    .sstate = TRACE_VFIO_PCI_NVLINK2_SETUP_QUIRK_LNKSPD_ENABLED,
    .dstate = &_TRACE_VFIO_PCI_NVLINK2_SETUP_QUIRK_LNKSPD_DSTATE 
};
...
TraceEvent _TRACE_VFIO_DMA_UNMAP_OVERFLOW_WORKAROUND_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "vfio_dma_unmap_overflow_workaround",
    .sstate = TRACE_VFIO_DMA_UNMAP_OVERFLOW_WORKAROUND_ENABLED,
    .dstate = &_TRACE_VFIO_DMA_UNMAP_OVERFLOW_WORKAROUND_DSTATE 
};
...
TraceEvent *hw_vfio_trace_events[] = {
    ...
    &_TRACE_VFIO_PCI_NVIDIA_GPU_SETUP_QUIRK_EVENT,
    &_TRACE_VFIO_PCI_NVLINK2_SETUP_QUIRK_SSATGT_EVENT,
    &_TRACE_VFIO_PCI_NVLINK2_SETUP_QUIRK_LNKSPD_EVENT,
    ...
    &_TRACE_VFIO_DMA_UNMAP_OVERFLOW_WORKAROUND_EVENT,
