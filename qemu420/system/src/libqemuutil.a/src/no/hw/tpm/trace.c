...
uint16_t _TRACE_TPM_TIS_SHOW_BUFFER_DSTATE;
...
TraceEvent _TRACE_TPM_TIS_SHOW_BUFFER_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "tpm_tis_show_buffer",
    .sstate = TRACE_TPM_TIS_SHOW_BUFFER_ENABLED,
    .dstate = &_TRACE_TPM_TIS_SHOW_BUFFER_DSTATE 
};
...
TraceEvent *hw_tpm_trace_events[] = {
    ...
    &_TRACE_TPM_TIS_SHOW_BUFFER_EVENT,
