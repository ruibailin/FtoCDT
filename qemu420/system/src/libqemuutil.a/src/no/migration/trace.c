...
uint16_t _TRACE_MULTIFD_SAVE_SETUP_WAIT_DSTATE;
...
uint16_t _TRACE_MIGRATION_THREAD_RATELIMIT_PRE_DSTATE;
uint16_t _TRACE_MIGRATION_THREAD_RATELIMIT_POST_DSTATE;
...
TraceEvent _TRACE_MULTIFD_SAVE_SETUP_WAIT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "multifd_save_setup_wait",
    .sstate = TRACE_MULTIFD_SAVE_SETUP_WAIT_ENABLED,
    .dstate = &_TRACE_MULTIFD_SAVE_SETUP_WAIT_DSTATE 
};
...
TraceEvent _TRACE_MIGRATION_THREAD_RATELIMIT_PRE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "migration_thread_ratelimit_pre",
    .sstate = TRACE_MIGRATION_THREAD_RATELIMIT_PRE_ENABLED,
    .dstate = &_TRACE_MIGRATION_THREAD_RATELIMIT_PRE_DSTATE 
};
TraceEvent _TRACE_MIGRATION_THREAD_RATELIMIT_POST_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "migration_thread_ratelimit_post",
    .sstate = TRACE_MIGRATION_THREAD_RATELIMIT_POST_ENABLED,
    .dstate = &_TRACE_MIGRATION_THREAD_RATELIMIT_POST_DSTATE 
};
...
TraceEvent *migration_trace_events[] = {
    ...
    &_TRACE_MULTIFD_SAVE_SETUP_WAIT_EVENT,
    ...
    &_TRACE_MIGRATION_THREAD_RATELIMIT_PRE_EVENT,
    &_TRACE_MIGRATION_THREAD_RATELIMIT_POST_EVENT,
