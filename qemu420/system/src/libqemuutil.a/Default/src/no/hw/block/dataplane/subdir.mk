...
C_SRCS += \
../src/no/hw/block/dataplane/trace.c 

OBJS += \
./src/no/hw/block/dataplane/trace.o 

C_DEPS += \
./src/no/hw/block/dataplane/trace.d 


# Each subdirectory must supply rules for building sources it contributes
src/no/hw/block/dataplane/%.o: ../src/no/hw/block/dataplane/%.c
	@echo 'Building file: $<'
