...
void visit_type_Qcow2BitmapInfoList(Visitor *v, const char *name, Qcow2BitmapInfoList **obj, Error **errp)
{
    Error *err = NULL;
    ...
    for (tail = *obj; tail;
        ...
        visit_type_Qcow2BitmapInfo(v, NULL, &tail->value, &err);
        if (err) {
            break;
        }
    }
...
void visit_type_ImageInfoSpecificQCow2_members(Visitor *v, ImageInfoSpecificQCow2 *obj, Error **errp)
{
    ...
    if (visit_optional(v, "data-file", &obj->has_data_file)) {
        visit_type_str(v, "data-file", &obj->data_file, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "data-file-raw", &obj->has_data_file_raw)) {
        visit_type_bool(v, "data-file-raw", &obj->data_file_raw, &err);
        if (err) {
            goto out;
        }
    }
    ...
    if (visit_optional(v, "bitmaps", &obj->has_bitmaps)) {
        visit_type_Qcow2BitmapInfoList(v, "bitmaps", &obj->bitmaps, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockDirtyInfo_members(Visitor *v, BlockDirtyInfo *obj, Error **errp)
{
    ...
    visit_type_bool(v, "recording", &obj->recording, &err);
    if (err) {
        goto out;
    }
    ...
    if (visit_optional(v, "inconsistent", &obj->has_inconsistent)) {
        visit_type_bool(v, "inconsistent", &obj->inconsistent, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_Qcow2BitmapInfoFlags(Visitor *v, const char *name, Qcow2BitmapInfoFlags *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &Qcow2BitmapInfoFlags_lookup, errp);
    *obj = value;
}

void visit_type_Qcow2BitmapInfoFlagsList(Visitor *v, const char *name, Qcow2BitmapInfoFlagsList **obj, Error **errp)
{
    Error *err = NULL;
    ...
    for (tail = *obj; tail;
        ...
        visit_type_Qcow2BitmapInfoFlags(v, NULL, &tail->value, &err);
        if (err) {
            break;
        }
    }
...
void visit_type_Qcow2BitmapInfo_members(Visitor *v, Qcow2BitmapInfo *obj, Error **errp)
{
    Error *err = NULL;
    ...
    visit_type_Qcow2BitmapInfoFlagsList(v, "flags", &obj->flags, &err);
    if (err) {
        goto out;
    }
...
void visit_type_Qcow2BitmapInfo(Visitor *v, const char *name, Qcow2BitmapInfo **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(Qcow2BitmapInfo), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_Qcow2BitmapInfo_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_BlockDeviceStats_members(Visitor *v, BlockDeviceStats *obj, Error **errp)
{
    ...
    visit_type_int(v, "unmap_bytes", &obj->unmap_bytes, &err);
    if (err) {
        goto out;
    }
    ...
    visit_type_int(v, "unmap_operations", &obj->unmap_operations, &err);
    if (err) {
        goto out;
    }
    ...
    visit_type_int(v, "unmap_total_time_ns", &obj->unmap_total_time_ns, &err);
    if (err) {
        goto out;
    }
    ...
    visit_type_int(v, "unmap_merged", &obj->unmap_merged, &err);
    if (err) {
        goto out;
    }
    ...
    visit_type_int(v, "failed_unmap_operations", &obj->failed_unmap_operations, &err);
    if (err) {
        goto out;
    }
    ...
    visit_type_int(v, "invalid_unmap_operations", &obj->invalid_unmap_operations, &err);
    if (err) {
        goto out;
    }
    ...
    if (visit_optional(v, "rd_latency_histogram", &obj->has_rd_latency_histogram)) {
        visit_type_BlockLatencyHistogramInfo(v, "rd_latency_histogram", &obj->rd_latency_histogram, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "wr_latency_histogram", &obj->has_wr_latency_histogram)) {
        visit_type_BlockLatencyHistogramInfo(v, "wr_latency_histogram", &obj->wr_latency_histogram, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "flush_latency_histogram", &obj->has_flush_latency_histogram)) {
        visit_type_BlockLatencyHistogramInfo(v, "flush_latency_histogram", &obj->flush_latency_histogram, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockStatsSpecificFile_members(Visitor *v, BlockStatsSpecificFile *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_uint64(v, "discard-nb-ok", &obj->discard_nb_ok, &err);
    if (err) {
        goto out;
    }
    visit_type_uint64(v, "discard-nb-failed", &obj->discard_nb_failed, &err);
    if (err) {
        goto out;
    }
    visit_type_uint64(v, "discard-bytes-ok", &obj->discard_bytes_ok, &err);
    if (err) {
        goto out;
    }
...
void visit_type_BlockStatsSpecificFile(Visitor *v, const char *name, BlockStatsSpecificFile **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockStatsSpecificFile), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockStatsSpecificFile_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_q_obj_BlockStatsSpecific_base_members(Visitor *v, q_obj_BlockStatsSpecific_base *obj, Error **errp)
{
    Error *err = NULL;
...
void visit_type_BlockStatsSpecific_members(Visitor *v, BlockStatsSpecific *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_q_obj_BlockStatsSpecific_base_members(v, (q_obj_BlockStatsSpecific_base *)obj, &err);
    if (err) {
        goto out;
    }
    switch (obj->driver) {
    case BLOCKDEV_DRIVER_FILE:
        visit_type_BlockStatsSpecificFile_members(v, &obj->u.file, &err);
        break;
    case BLOCKDEV_DRIVER_HOST_DEVICE:
        visit_type_BlockStatsSpecificFile_members(v, &obj->u.host_device, &err);
        break;
...
void visit_type_BlockStatsSpecific(Visitor *v, const char *name, BlockStatsSpecific **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockStatsSpecific), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockStatsSpecific_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_BlockStats_members(Visitor *v, BlockStats *obj, Error **errp)
{
    ...
    if (visit_optional(v, "driver-specific", &obj->has_driver_specific)) {
        visit_type_BlockStatsSpecific(v, "driver-specific", &obj->driver_specific, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BitmapSyncMode(Visitor *v, const char *name, BitmapSyncMode *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &BitmapSyncMode_lookup, errp);
    *obj = value;
}

void visit_type_MirrorCopyMode(Visitor *v, const char *name, MirrorCopyMode *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &MirrorCopyMode_lookup, errp);
    *obj = value;
}
...
void visit_type_BackupCommon_members(Visitor *v, BackupCommon *obj, Error **errp)
{
    Error *err = NULL;
    ...
    if (visit_optional(v, "bitmap-mode", &obj->has_bitmap_mode)) {
        visit_type_BitmapSyncMode(v, "bitmap-mode", &obj->bitmap_mode, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BackupCommon(Visitor *v, const char *name, BackupCommon **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BackupCommon), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BackupCommon_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_DriveBackup_members(Visitor *v, DriveBackup *obj, Error **errp)
{
    ...
    visit_type_BackupCommon_members(v, (BackupCommon *)obj, &err);
    if (err) {
        goto out;
    }
...
void visit_type_q_obj_block_commit_arg_members(Visitor *v, q_obj_block_commit_arg *obj, Error **errp)
{
    ...
    if (visit_optional(v, "top-node", &obj->has_top_node)) {
        visit_type_str(v, "top-node", &obj->top_node, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_XDbgBlockGraphNodeType(Visitor *v, const char *name, XDbgBlockGraphNodeType *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &XDbgBlockGraphNodeType_lookup, errp);
    *obj = value;
}

void visit_type_XDbgBlockGraphNode_members(Visitor *v, XDbgBlockGraphNode *obj, Error **errp)
{
    Error *err = NULL;
    ...
    visit_type_XDbgBlockGraphNodeType(v, "type", &obj->type, &err);
    if (err) {
        goto out;
    }
    visit_type_str(v, "name", &obj->name, &err);
...
void visit_type_XDbgBlockGraphNode(Visitor *v, const char *name, XDbgBlockGraphNode **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(XDbgBlockGraphNode), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_XDbgBlockGraphNode_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_BlockPermission(Visitor *v, const char *name, BlockPermission *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &BlockPermission_lookup, errp);
    *obj = value;
}

void visit_type_BlockPermissionList(Visitor *v, const char *name, BlockPermissionList **obj, Error **errp)
{
    Error *err = NULL;
    ...
    for (tail = *obj; tail;
        ...
        visit_type_BlockPermission(v, NULL, &tail->value, &err);
        if (err) {
            break;
        }
    }
...
void visit_type_XDbgBlockGraphEdge_members(Visitor *v, XDbgBlockGraphEdge *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_uint64(v, "parent", &obj->parent, &err);
    if (err) {
        goto out;
    }
    visit_type_uint64(v, "child", &obj->child, &err);
    if (err) {
        goto out;
    }
    visit_type_str(v, "name", &obj->name, &err);
    ...
    visit_type_BlockPermissionList(v, "perm", &obj->perm, &err);
    if (err) {
        goto out;
    }
    visit_type_BlockPermissionList(v, "shared-perm", &obj->shared_perm, &err);
    if (err) {
        goto out;
    }
...
void visit_type_XDbgBlockGraphEdge(Visitor *v, const char *name, XDbgBlockGraphEdge **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(XDbgBlockGraphEdge), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_XDbgBlockGraphEdge_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_XDbgBlockGraphNodeList(Visitor *v, const char *name, XDbgBlockGraphNodeList **obj, Error **errp)
{
    Error *err = NULL;
    ...
    for (tail = *obj; tail;
        ...
        visit_type_XDbgBlockGraphNode(v, NULL, &tail->value, &err);
        if (err) {
            break;
        }
    }
...
void visit_type_XDbgBlockGraphEdgeList(Visitor *v, const char *name, XDbgBlockGraphEdgeList **obj, Error **errp)
{
    Error *err = NULL;
    ...
    for (tail = *obj; tail;
        ...
        visit_type_XDbgBlockGraphEdge(v, NULL, &tail->value, &err);
        if (err) {
            break;
        }
    }
...
void visit_type_XDbgBlockGraph_members(Visitor *v, XDbgBlockGraph *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_XDbgBlockGraphNodeList(v, "nodes", &obj->nodes, &err);
    if (err) {
        goto out;
    }
    visit_type_XDbgBlockGraphEdgeList(v, "edges", &obj->edges, &err);
    if (err) {
        goto out;
    }
...
void visit_type_XDbgBlockGraph(Visitor *v, const char *name, XDbgBlockGraph **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(XDbgBlockGraph), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_XDbgBlockGraph_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_DriveMirror_members(Visitor *v, DriveMirror *obj, Error **errp)
{
    ...
    if (visit_optional(v, "copy-mode", &obj->has_copy_mode)) {
        visit_type_MirrorCopyMode(v, "copy-mode", &obj->copy_mode, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockDirtyBitmapAdd_members(Visitor *v, BlockDirtyBitmapAdd *obj, Error **errp)
{
    ...
    if (visit_optional(v, "disabled", &obj->has_disabled)) {
        visit_type_bool(v, "disabled", &obj->disabled, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockDirtyBitmapMergeSourceList(Visitor *v, const char *name, BlockDirtyBitmapMergeSourceList **obj, Error **errp)
{
    Error *err = NULL;
    ...
    for (tail = *obj; tail;
        ...
        visit_type_BlockDirtyBitmapMergeSource(v, NULL, &tail->value, &err);
        if (err) {
            break;
        }
    }
...
void visit_type_BlockDirtyBitmapMerge_members(Visitor *v, BlockDirtyBitmapMerge *obj, Error **errp)
{
    Error *err = NULL;
    ...
    visit_type_BlockDirtyBitmapMergeSourceList(v, "bitmaps", &obj->bitmaps, &err);
    if (err) {
        goto out;
    }
...
void visit_type_BlockDirtyBitmapMerge(Visitor *v, const char *name, BlockDirtyBitmapMerge **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockDirtyBitmapMerge), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockDirtyBitmapMerge_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_BlockdevOptionsFile_members(Visitor *v, BlockdevOptionsFile *obj, Error **errp)
{
    ...
    if (visit_optional(v, "drop-cache", &obj->has_drop_cache)) {
        visit_type_bool(v, "drop-cache", &obj->drop_cache, &err);
        if (err) {
            goto out;
        }
    }
    ...
    if (visit_optional(v, "x-check-cache-dropped", &obj->has_x_check_cache_dropped)) {
        visit_type_bool(v, "x-check-cache-dropped", &obj->x_check_cache_dropped, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockdevOptionsNull_members(Visitor *v, BlockdevOptionsNull *obj, Error **errp)
{
    ...
    if (visit_optional(v, "read-zeroes", &obj->has_read_zeroes)) {
        visit_type_bool(v, "read-zeroes", &obj->read_zeroes, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_Qcow2OverlapCheckFlags_members(Visitor *v, Qcow2OverlapCheckFlags *obj, Error **errp)
{
    ...
    if (visit_optional(v, "bitmap-directory", &obj->has_bitmap_directory)) {
        visit_type_bool(v, "bitmap-directory", &obj->bitmap_directory, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockdevOptionsQcow2_members(Visitor *v, BlockdevOptionsQcow2 *obj, Error **errp)
{
    ...
    if (visit_optional(v, "data-file", &obj->has_data_file)) {
        visit_type_BlockdevRef(v, "data-file", &obj->data_file, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlkdebugIOType(Visitor *v, const char *name, BlkdebugIOType *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &BlkdebugIOType_lookup, errp);
    *obj = value;
}
...
void visit_type_BlkdebugInjectErrorOptions_members(Visitor *v, BlkdebugInjectErrorOptions *obj, Error **errp)
{
    ...
    if (visit_optional(v, "iotype", &obj->has_iotype)) {
        visit_type_BlkdebugIOType(v, "iotype", &obj->iotype, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockdevOptionsBlklogwrites_members(Visitor *v, BlockdevOptionsBlklogwrites *obj, Error **errp)
{
    Error *err = NULL;
    ...
    visit_type_BlockdevRef(v, "log", &obj->log, &err);
    if (err) {
        goto out;
    }
    if (visit_optional(v, "log-sector-size", &obj->has_log_sector_size)) {
        visit_type_uint32(v, "log-sector-size", &obj->log_sector_size, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "log-append", &obj->has_log_append)) {
        visit_type_bool(v, "log-append", &obj->log_append, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "log-super-update-interval", &obj->has_log_super_update_interval)) {
        visit_type_uint64(v, "log-super-update-interval", &obj->log_super_update_interval, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockdevOptionsBlklogwrites(Visitor *v, const char *name, BlockdevOptionsBlklogwrites **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockdevOptionsBlklogwrites), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockdevOptionsBlklogwrites_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_BlockdevOptionsBlkreplay_members(Visitor *v, BlockdevOptionsBlkreplay *obj, Error **errp)
{
    Error *err = NULL;
...
void visit_type_BlockdevOptionsBlkreplay(Visitor *v, const char *name, BlockdevOptionsBlkreplay **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockdevOptionsBlkreplay), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockdevOptionsBlkreplay_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_RbdAuthMode(Visitor *v, const char *name, RbdAuthMode *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &RbdAuthMode_lookup, errp);
    *obj = value;
}

void visit_type_RbdAuthModeList(Visitor *v, const char *name, RbdAuthModeList **obj, Error **errp)
{
    Error *err = NULL;
    ...
    for (tail = *obj; tail;
        ...
        visit_type_RbdAuthMode(v, NULL, &tail->value, &err);
        if (err) {
            break;
        }
    }
...
void visit_type_BlockdevOptionsRbd_members(Visitor *v, BlockdevOptionsRbd *obj, Error **errp)
{
    ...
    if (visit_optional(v, "auth-client-required", &obj->has_auth_client_required)) {
        visit_type_RbdAuthModeList(v, "auth-client-required", &obj->auth_client_required, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockdevOptionsNbd_members(Visitor *v, BlockdevOptionsNbd *obj, Error **errp)
{
    ...
    if (visit_optional(v, "x-dirty-bitmap", &obj->has_x_dirty_bitmap)) {
        visit_type_str(v, "x-dirty-bitmap", &obj->x_dirty_bitmap, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "reconnect-delay", &obj->has_reconnect_delay)) {
        visit_type_uint32(v, "reconnect-delay", &obj->reconnect_delay, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_q_obj_BlockdevOptions_base_members(Visitor *v, q_obj_BlockdevOptions_base *obj, Error **errp)
{
    ...
    if (visit_optional(v, "auto-read-only", &obj->has_auto_read_only)) {
        visit_type_bool(v, "auto-read-only", &obj->auto_read_only, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockdevOptions_members(Visitor *v, BlockdevOptions *obj, Error **errp)
{
    ...
    case BLOCKDEV_DRIVER_BLKDEBUG:
        ...
        break;
    case BLOCKDEV_DRIVER_BLKLOGWRITES:
        visit_type_BlockdevOptionsBlklogwrites_members(v, &obj->u.blklogwrites, &err);
        break;
    case BLOCKDEV_DRIVER_BLKVERIFY:
        visit_type_BlockdevOptionsBlkverify_members(v, &obj->u.blkverify, &err);
        break;
    case BLOCKDEV_DRIVER_BLKREPLAY:
        visit_type_BlockdevOptionsBlkreplay_members(v, &obj->u.blkreplay, &err);
        break;
    case BLOCKDEV_DRIVER_BOCHS:
    ...
    case BLOCKDEV_DRIVER_CLOOP:
        ...
        break;
    case BLOCKDEV_DRIVER_COPY_ON_READ:
        visit_type_BlockdevOptionsGenericFormat_members(v, &obj->u.copy_on_read, &err);
        break;
    case BLOCKDEV_DRIVER_DMG:
...
void visit_type_BlockdevVmdkSubformat(Visitor *v, const char *name, BlockdevVmdkSubformat *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &BlockdevVmdkSubformat_lookup, errp);
    *obj = value;
}

void visit_type_BlockdevVmdkAdapterType(Visitor *v, const char *name, BlockdevVmdkAdapterType *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &BlockdevVmdkAdapterType_lookup, errp);
    *obj = value;
}

void visit_type_BlockdevCreateOptionsVmdk_members(Visitor *v, BlockdevCreateOptionsVmdk *obj, Error **errp)
{
    Error *err = NULL;
    ...
    if (visit_optional(v, "extents", &obj->has_extents)) {
        visit_type_BlockdevRefList(v, "extents", &obj->extents, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "subformat", &obj->has_subformat)) {
        visit_type_BlockdevVmdkSubformat(v, "subformat", &obj->subformat, &err);
        if (err) {
            goto out;
        }
    }
    ...
    if (visit_optional(v, "adapter-type", &obj->has_adapter_type)) {
        visit_type_BlockdevVmdkAdapterType(v, "adapter-type", &obj->adapter_type, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "hwversion", &obj->has_hwversion)) {
        visit_type_str(v, "hwversion", &obj->hwversion, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "zeroed-grain", &obj->has_zeroed_grain)) {
        visit_type_bool(v, "zeroed-grain", &obj->zeroed_grain, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockdevCreateOptionsVmdk(Visitor *v, const char *name, BlockdevCreateOptionsVmdk **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockdevCreateOptionsVmdk), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockdevCreateOptionsVmdk_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_BlockdevCreateOptions_members(Visitor *v, BlockdevCreateOptions *obj, Error **errp)
{
    ...
    case BLOCKDEV_DRIVER_VHDX:
        ...
        break;
    case BLOCKDEV_DRIVER_VMDK:
        visit_type_BlockdevCreateOptionsVmdk_members(v, &obj->u.vmdk, &err);
        break;
    case BLOCKDEV_DRIVER_VPC:
...
void visit_type_q_obj_blockdev_create_arg_members(Visitor *v, q_obj_blockdev_create_arg *obj, Error **errp)
{
    Error *err = NULL;
    ...
    visit_type_BlockdevCreateOptions(v, "options", &obj->options, &err);
    if (err) {
        goto out;
    }
