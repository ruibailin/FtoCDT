...
C_SRCS += \
../src/no/hw/virtio/vhost-backend.c \
../src/no/hw/virtio/vhost-scsi-pci.c \
../src/no/hw/virtio/vhost-user-blk-pci.c \
../src/no/hw/virtio/vhost-user-fs-pci.c \
../src/no/hw/virtio/vhost-user-fs.c \
../src/no/hw/virtio/vhost-user-input-pci.c \
../src/no/hw/virtio/vhost-user-scsi-pci.c \
../src/no/hw/virtio/vhost-user.c \
../src/no/hw/virtio/vhost-vsock-pci.c \
../src/no/hw/virtio/vhost-vsock.c \
../src/no/hw/virtio/vhost.c \
../src/no/hw/virtio/virtio-9p-pci.c \
../src/no/hw/virtio/virtio-balloon-pci.c \
../src/no/hw/virtio/virtio-balloon.c \
../src/no/hw/virtio/virtio-blk-pci.c \
../src/no/hw/virtio/virtio-bus.c \
../src/no/hw/virtio/virtio-crypto-pci.c \
../src/no/hw/virtio/virtio-crypto.c \
../src/no/hw/virtio/virtio-input-host-pci.c \
../src/no/hw/virtio/virtio-input-pci.c \
../src/no/hw/virtio/virtio-mmio.c \
../src/no/hw/virtio/virtio-net-pci.c \
../src/no/hw/virtio/virtio-pci.c \
../src/no/hw/virtio/virtio-rng-pci.c \
../src/no/hw/virtio/virtio-rng.c \
../src/no/hw/virtio/virtio-scsi-pci.c \
../src/no/hw/virtio/virtio-serial-pci.c \
../src/no/hw/virtio/virtio.c 

OBJS += \
./src/no/hw/virtio/vhost-backend.o \
./src/no/hw/virtio/vhost-scsi-pci.o \
./src/no/hw/virtio/vhost-user-blk-pci.o \
./src/no/hw/virtio/vhost-user-fs-pci.o \
./src/no/hw/virtio/vhost-user-fs.o \
./src/no/hw/virtio/vhost-user-input-pci.o \
./src/no/hw/virtio/vhost-user-scsi-pci.o \
./src/no/hw/virtio/vhost-user.o \
./src/no/hw/virtio/vhost-vsock-pci.o \
./src/no/hw/virtio/vhost-vsock.o \
./src/no/hw/virtio/vhost.o \
./src/no/hw/virtio/virtio-9p-pci.o \
./src/no/hw/virtio/virtio-balloon-pci.o \
./src/no/hw/virtio/virtio-balloon.o \
./src/no/hw/virtio/virtio-blk-pci.o \
./src/no/hw/virtio/virtio-bus.o \
./src/no/hw/virtio/virtio-crypto-pci.o \
./src/no/hw/virtio/virtio-crypto.o \
./src/no/hw/virtio/virtio-input-host-pci.o \
./src/no/hw/virtio/virtio-input-pci.o \
./src/no/hw/virtio/virtio-mmio.o \
./src/no/hw/virtio/virtio-net-pci.o \
./src/no/hw/virtio/virtio-pci.o \
./src/no/hw/virtio/virtio-rng-pci.o \
./src/no/hw/virtio/virtio-rng.o \
./src/no/hw/virtio/virtio-scsi-pci.o \
./src/no/hw/virtio/virtio-serial-pci.o \
./src/no/hw/virtio/virtio.o 

C_DEPS += \
./src/no/hw/virtio/vhost-backend.d \
./src/no/hw/virtio/vhost-scsi-pci.d \
./src/no/hw/virtio/vhost-user-blk-pci.d \
./src/no/hw/virtio/vhost-user-fs-pci.d \
./src/no/hw/virtio/vhost-user-fs.d \
./src/no/hw/virtio/vhost-user-input-pci.d \
./src/no/hw/virtio/vhost-user-scsi-pci.d \
./src/no/hw/virtio/vhost-user.d \
./src/no/hw/virtio/vhost-vsock-pci.d \
./src/no/hw/virtio/vhost-vsock.d \
./src/no/hw/virtio/vhost.d \
./src/no/hw/virtio/virtio-9p-pci.d \
./src/no/hw/virtio/virtio-balloon-pci.d \
./src/no/hw/virtio/virtio-balloon.d \
./src/no/hw/virtio/virtio-blk-pci.d \
./src/no/hw/virtio/virtio-bus.d \
./src/no/hw/virtio/virtio-crypto-pci.d \
./src/no/hw/virtio/virtio-crypto.d \
./src/no/hw/virtio/virtio-input-host-pci.d \
./src/no/hw/virtio/virtio-input-pci.d \
./src/no/hw/virtio/virtio-mmio.d \
./src/no/hw/virtio/virtio-net-pci.d \
./src/no/hw/virtio/virtio-pci.d \
./src/no/hw/virtio/virtio-rng-pci.d \
./src/no/hw/virtio/virtio-rng.d \
./src/no/hw/virtio/virtio-scsi-pci.d \
./src/no/hw/virtio/virtio-serial-pci.d \
./src/no/hw/virtio/virtio.d 


# Each subdirectory must supply rules for building sources it contributes
src/no/hw/virtio/%.o: ../src/no/hw/virtio/%.c
	@echo 'Building file: $<'
