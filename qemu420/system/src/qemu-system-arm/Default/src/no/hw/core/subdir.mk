...
C_SRCS += \
../src/no/hw/core/bus.c \
../src/no/hw/core/cpu.c \
../src/no/hw/core/fw-path-provider.c \
../src/no/hw/core/generic-loader.c \
../src/no/hw/core/hotplug.c \
../src/no/hw/core/irq.c \
../src/no/hw/core/loader.c \
../src/no/hw/core/machine-hmp-cmds.c \
../src/no/hw/core/machine-qmp-cmds.c \
../src/no/hw/core/machine.c \
../src/no/hw/core/nmi.c \
../src/no/hw/core/null-machine.c \
../src/no/hw/core/numa.c \
../src/no/hw/core/or-irq.c \
../src/no/hw/core/platform-bus.c \
../src/no/hw/core/ptimer.c \
../src/no/hw/core/qdev-fw.c \
../src/no/hw/core/qdev-properties-system.c \
../src/no/hw/core/qdev-properties.c \
../src/no/hw/core/qdev.c \
../src/no/hw/core/register.c \
../src/no/hw/core/reset.c \
../src/no/hw/core/split-irq.c \
../src/no/hw/core/stream.c \
../src/no/hw/core/sysbus.c \
../src/no/hw/core/vm-change-state-handler.c 

OBJS += \
./src/no/hw/core/bus.o \
./src/no/hw/core/cpu.o \
./src/no/hw/core/fw-path-provider.o \
./src/no/hw/core/generic-loader.o \
./src/no/hw/core/hotplug.o \
./src/no/hw/core/irq.o \
./src/no/hw/core/loader.o \
./src/no/hw/core/machine-hmp-cmds.o \
./src/no/hw/core/machine-qmp-cmds.o \
./src/no/hw/core/machine.o \
./src/no/hw/core/nmi.o \
./src/no/hw/core/null-machine.o \
./src/no/hw/core/numa.o \
./src/no/hw/core/or-irq.o \
./src/no/hw/core/platform-bus.o \
./src/no/hw/core/ptimer.o \
./src/no/hw/core/qdev-fw.o \
./src/no/hw/core/qdev-properties-system.o \
./src/no/hw/core/qdev-properties.o \
./src/no/hw/core/qdev.o \
./src/no/hw/core/register.o \
./src/no/hw/core/reset.o \
./src/no/hw/core/split-irq.o \
./src/no/hw/core/stream.o \
./src/no/hw/core/sysbus.o \
./src/no/hw/core/vm-change-state-handler.o 

C_DEPS += \
./src/no/hw/core/bus.d \
./src/no/hw/core/cpu.d \
./src/no/hw/core/fw-path-provider.d \
./src/no/hw/core/generic-loader.d \
./src/no/hw/core/hotplug.d \
./src/no/hw/core/irq.d \
./src/no/hw/core/loader.d \
./src/no/hw/core/machine-hmp-cmds.d \
./src/no/hw/core/machine-qmp-cmds.d \
./src/no/hw/core/machine.d \
./src/no/hw/core/nmi.d \
./src/no/hw/core/null-machine.d \
./src/no/hw/core/numa.d \
./src/no/hw/core/or-irq.d \
./src/no/hw/core/platform-bus.d \
./src/no/hw/core/ptimer.d \
./src/no/hw/core/qdev-fw.d \
./src/no/hw/core/qdev-properties-system.d \
./src/no/hw/core/qdev-properties.d \
./src/no/hw/core/qdev.d \
./src/no/hw/core/register.d \
./src/no/hw/core/reset.d \
./src/no/hw/core/split-irq.d \
./src/no/hw/core/stream.d \
./src/no/hw/core/sysbus.d \
./src/no/hw/core/vm-change-state-handler.d 


# Each subdirectory must supply rules for building sources it contributes
src/no/hw/core/%.o: ../src/no/hw/core/%.c
	@echo 'Building file: $<'
