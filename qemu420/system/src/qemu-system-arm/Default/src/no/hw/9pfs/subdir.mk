...
C_SRCS += \
../src/no/hw/9pfs/9p-local.c \
../src/no/hw/9pfs/9p-posix-acl.c \
../src/no/hw/9pfs/9p-proxy.c \
../src/no/hw/9pfs/9p-synth.c \
../src/no/hw/9pfs/9p-util.c \
../src/no/hw/9pfs/9p-xattr-user.c \
../src/no/hw/9pfs/9p-xattr.c \
../src/no/hw/9pfs/9p.c \
../src/no/hw/9pfs/codir.c \
../src/no/hw/9pfs/cofile.c \
../src/no/hw/9pfs/cofs.c \
../src/no/hw/9pfs/coth.c \
../src/no/hw/9pfs/coxattr.c \
../src/no/hw/9pfs/virtio-9p-device.c 

OBJS += \
./src/no/hw/9pfs/9p-local.o \
./src/no/hw/9pfs/9p-posix-acl.o \
./src/no/hw/9pfs/9p-proxy.o \
./src/no/hw/9pfs/9p-synth.o \
./src/no/hw/9pfs/9p-util.o \
./src/no/hw/9pfs/9p-xattr-user.o \
./src/no/hw/9pfs/9p-xattr.o \
./src/no/hw/9pfs/9p.o \
./src/no/hw/9pfs/codir.o \
./src/no/hw/9pfs/cofile.o \
./src/no/hw/9pfs/cofs.o \
./src/no/hw/9pfs/coth.o \
./src/no/hw/9pfs/coxattr.o \
./src/no/hw/9pfs/virtio-9p-device.o 

C_DEPS += \
./src/no/hw/9pfs/9p-local.d \
./src/no/hw/9pfs/9p-posix-acl.d \
./src/no/hw/9pfs/9p-proxy.d \
./src/no/hw/9pfs/9p-synth.d \
./src/no/hw/9pfs/9p-util.d \
./src/no/hw/9pfs/9p-xattr-user.d \
./src/no/hw/9pfs/9p-xattr.d \
./src/no/hw/9pfs/9p.d \
./src/no/hw/9pfs/codir.d \
./src/no/hw/9pfs/cofile.d \
./src/no/hw/9pfs/cofs.d \
./src/no/hw/9pfs/coth.d \
./src/no/hw/9pfs/coxattr.d \
./src/no/hw/9pfs/virtio-9p-device.d 


# Each subdirectory must supply rules for building sources it contributes
src/no/hw/9pfs/%.o: ../src/no/hw/9pfs/%.c
	@echo 'Building file: $<'
