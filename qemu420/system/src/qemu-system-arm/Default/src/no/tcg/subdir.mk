...
C_SRCS += \
../src/no/tcg/optimize.c \
../src/no/tcg/tcg-common.c \
../src/no/tcg/tcg-op-gvec.c \
../src/no/tcg/tcg-op-vec.c \
../src/no/tcg/tcg-op.c \
../src/no/tcg/tcg.c 

OBJS += \
./src/no/tcg/optimize.o \
./src/no/tcg/tcg-common.o \
./src/no/tcg/tcg-op-gvec.o \
./src/no/tcg/tcg-op-vec.o \
./src/no/tcg/tcg-op.o \
./src/no/tcg/tcg.o 

C_DEPS += \
./src/no/tcg/optimize.d \
./src/no/tcg/tcg-common.d \
./src/no/tcg/tcg-op-gvec.d \
./src/no/tcg/tcg-op-vec.d \
./src/no/tcg/tcg-op.d \
./src/no/tcg/tcg.d 


# Each subdirectory must supply rules for building sources it contributes
src/no/tcg/%.o: ../src/no/tcg/%.c
	@echo 'Building file: $<'
