...
C_SRCS += \
../src/no/monitor/hmp-cmds.c \
../src/no/monitor/hmp.c \
../src/no/monitor/misc.c \
../src/no/monitor/monitor.c \
../src/no/monitor/qmp-cmds.c \
../src/no/monitor/qmp.c 

OBJS += \
./src/no/monitor/hmp-cmds.o \
./src/no/monitor/hmp.o \
./src/no/monitor/misc.o \
./src/no/monitor/monitor.o \
./src/no/monitor/qmp-cmds.o \
./src/no/monitor/qmp.o 

C_DEPS += \
./src/no/monitor/hmp-cmds.d \
./src/no/monitor/hmp.d \
./src/no/monitor/misc.d \
./src/no/monitor/monitor.d \
./src/no/monitor/qmp-cmds.d \
./src/no/monitor/qmp.d 


# Each subdirectory must supply rules for building sources it contributes
src/no/monitor/%.o: ../src/no/monitor/%.c
	@echo 'Building file: $<'
