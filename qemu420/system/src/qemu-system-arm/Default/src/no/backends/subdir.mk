...
C_SRCS += \
../src/no/backends/cryptodev-builtin.c \
../src/no/backends/cryptodev-vhost-user.c \
../src/no/backends/cryptodev-vhost.c \
../src/no/backends/cryptodev.c \
../src/no/backends/hostmem-file.c \
../src/no/backends/hostmem-memfd.c \
../src/no/backends/hostmem-ram.c \
../src/no/backends/hostmem.c \
../src/no/backends/rng-builtin.c \
../src/no/backends/rng-egd.c \
../src/no/backends/rng-random.c \
../src/no/backends/rng.c \
../src/no/backends/tpm.c \
../src/no/backends/vhost-user.c 

OBJS += \
./src/no/backends/cryptodev-builtin.o \
./src/no/backends/cryptodev-vhost-user.o \
./src/no/backends/cryptodev-vhost.o \
./src/no/backends/cryptodev.o \
./src/no/backends/hostmem-file.o \
./src/no/backends/hostmem-memfd.o \
./src/no/backends/hostmem-ram.o \
./src/no/backends/hostmem.o \
./src/no/backends/rng-builtin.o \
./src/no/backends/rng-egd.o \
./src/no/backends/rng-random.o \
./src/no/backends/rng.o \
./src/no/backends/tpm.o \
./src/no/backends/vhost-user.o 

C_DEPS += \
./src/no/backends/cryptodev-builtin.d \
./src/no/backends/cryptodev-vhost-user.d \
./src/no/backends/cryptodev-vhost.d \
./src/no/backends/cryptodev.d \
./src/no/backends/hostmem-file.d \
./src/no/backends/hostmem-memfd.d \
./src/no/backends/hostmem-ram.d \
./src/no/backends/hostmem.d \
./src/no/backends/rng-builtin.d \
./src/no/backends/rng-egd.d \
./src/no/backends/rng-random.d \
./src/no/backends/rng.d \
./src/no/backends/tpm.d \
./src/no/backends/vhost-user.d 


# Each subdirectory must supply rules for building sources it contributes
src/no/backends/%.o: ../src/no/backends/%.c
	@echo 'Building file: $<'
