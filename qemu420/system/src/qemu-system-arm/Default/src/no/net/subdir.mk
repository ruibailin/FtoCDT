...
C_SRCS += \
../src/no/net/announce.c \
../src/no/net/checksum.c \
../src/no/net/colo-compare.c \
../src/no/net/colo.c \
../src/no/net/dump.c \
../src/no/net/eth.c \
../src/no/net/filter-buffer.c \
../src/no/net/filter-mirror.c \
../src/no/net/filter-replay.c \
../src/no/net/filter-rewriter.c \
../src/no/net/filter.c \
../src/no/net/hub.c \
../src/no/net/l2tpv3.c \
../src/no/net/net.c \
...
../src/no/net/slirp.c \
../src/no/net/socket.c \
../src/no/net/tap-linux.c \
../src/no/net/tap.c \
../src/no/net/util.c \
../src/no/net/vhost-user.c 

OBJS += \
./src/no/net/announce.o \
./src/no/net/checksum.o \
./src/no/net/colo-compare.o \
./src/no/net/colo.o \
./src/no/net/dump.o \
./src/no/net/eth.o \
./src/no/net/filter-buffer.o \
./src/no/net/filter-mirror.o \
./src/no/net/filter-replay.o \
./src/no/net/filter-rewriter.o \
./src/no/net/filter.o \
./src/no/net/hub.o \
./src/no/net/l2tpv3.o \
./src/no/net/net.o \
...
./src/no/net/slirp.o \
./src/no/net/socket.o \
./src/no/net/tap-linux.o \
./src/no/net/tap.o \
./src/no/net/util.o \
./src/no/net/vhost-user.o 

C_DEPS += \
./src/no/net/announce.d \
./src/no/net/checksum.d \
./src/no/net/colo-compare.d \
./src/no/net/colo.d \
./src/no/net/dump.d \
./src/no/net/eth.d \
./src/no/net/filter-buffer.d \
./src/no/net/filter-mirror.d \
./src/no/net/filter-replay.d \
./src/no/net/filter-rewriter.d \
./src/no/net/filter.d \
./src/no/net/hub.d \
./src/no/net/l2tpv3.d \
./src/no/net/net.d \
...
./src/no/net/slirp.d \
./src/no/net/socket.d \
./src/no/net/tap-linux.d \
./src/no/net/tap.d \
./src/no/net/util.d \
./src/no/net/vhost-user.d 
