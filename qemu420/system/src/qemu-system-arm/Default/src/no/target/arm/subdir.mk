...
C_SRCS += \
../src/no/target/arm/arch_dump.c \
../src/no/target/arm/arm-powerctl.c \
../src/no/target/arm/arm-semi.c \
../src/no/target/arm/cpu.c \
../src/no/target/arm/crypto_helper.c \
../src/no/target/arm/debug_helper.c \
../src/no/target/arm/gdbstub.c \
../src/no/target/arm/helper.c \
../src/no/target/arm/iwmmxt_helper.c \
../src/no/target/arm/kvm-stub.c \
../src/no/target/arm/m_helper.c \
../src/no/target/arm/machine.c \
../src/no/target/arm/monitor.c \
../src/no/target/arm/neon_helper.c \
../src/no/target/arm/op_helper.c \
../src/no/target/arm/psci.c \
../src/no/target/arm/tlb_helper.c \
../src/no/target/arm/translate.c \
../src/no/target/arm/vec_helper.c \
../src/no/target/arm/vfp_helper.c 

OBJS += \
./src/no/target/arm/arch_dump.o \
./src/no/target/arm/arm-powerctl.o \
./src/no/target/arm/arm-semi.o \
./src/no/target/arm/cpu.o \
./src/no/target/arm/crypto_helper.o \
./src/no/target/arm/debug_helper.o \
./src/no/target/arm/gdbstub.o \
./src/no/target/arm/helper.o \
./src/no/target/arm/iwmmxt_helper.o \
./src/no/target/arm/kvm-stub.o \
./src/no/target/arm/m_helper.o \
./src/no/target/arm/machine.o \
./src/no/target/arm/monitor.o \
./src/no/target/arm/neon_helper.o \
./src/no/target/arm/op_helper.o \
./src/no/target/arm/psci.o \
./src/no/target/arm/tlb_helper.o \
./src/no/target/arm/translate.o \
./src/no/target/arm/vec_helper.o \
./src/no/target/arm/vfp_helper.o 

C_DEPS += \
./src/no/target/arm/arch_dump.d \
./src/no/target/arm/arm-powerctl.d \
./src/no/target/arm/arm-semi.d \
./src/no/target/arm/cpu.d \
./src/no/target/arm/crypto_helper.d \
./src/no/target/arm/debug_helper.d \
./src/no/target/arm/gdbstub.d \
./src/no/target/arm/helper.d \
./src/no/target/arm/iwmmxt_helper.d \
./src/no/target/arm/kvm-stub.d \
./src/no/target/arm/m_helper.d \
./src/no/target/arm/machine.d \
./src/no/target/arm/monitor.d \
./src/no/target/arm/neon_helper.d \
./src/no/target/arm/op_helper.d \
./src/no/target/arm/psci.d \
./src/no/target/arm/tlb_helper.d \
./src/no/target/arm/translate.d \
./src/no/target/arm/vec_helper.d \
./src/no/target/arm/vfp_helper.d 


# Each subdirectory must supply rules for building sources it contributes
src/no/target/arm/%.o: ../src/no/target/arm/%.c
	@echo 'Building file: $<'
