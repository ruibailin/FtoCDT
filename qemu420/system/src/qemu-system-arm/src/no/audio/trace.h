...
{
    if (trace_event_get_state(TRACE_ALSA_RESUME_IN) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:alsa_resume_in " "Resuming suspended input stream" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
{
    if (trace_event_get_state(TRACE_ALSA_NO_FRAMES) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:alsa_no_frames " "No frames available and ALSA state is %d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , state);
    }
...
{
    if (trace_event_get_state(TRACE_OSS_INVALID_AVAILABLE_SIZE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:oss_invalid_available_size " "Invalid available size, size=%d bufsize=%d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , size, bufsize);
    }
