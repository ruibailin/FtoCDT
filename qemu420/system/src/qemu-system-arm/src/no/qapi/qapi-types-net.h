...
typedef enum NetLegacyOptionsType {
    NET_LEGACY_OPTIONS_TYPE_NONE,
    NET_LEGACY_OPTIONS_TYPE_NIC,
    NET_LEGACY_OPTIONS_TYPE_USER,
    NET_LEGACY_OPTIONS_TYPE_TAP,
    NET_LEGACY_OPTIONS_TYPE_L2TPV3,
    NET_LEGACY_OPTIONS_TYPE_SOCKET,
    NET_LEGACY_OPTIONS_TYPE_VDE,
    NET_LEGACY_OPTIONS_TYPE_BRIDGE,
    NET_LEGACY_OPTIONS_TYPE_NETMAP,
    NET_LEGACY_OPTIONS_TYPE_VHOST_USER,
    NET_LEGACY_OPTIONS_TYPE__MAX,
