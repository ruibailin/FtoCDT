...
extern TraceEvent _TRACE_SMMUV3_CMDQ_TLBI_NH_VA_EVENT;
extern TraceEvent _TRACE_SMMUV3_CMDQ_TLBI_NH_VAA_EVENT;
extern TraceEvent _TRACE_SMMUV3_CMDQ_TLBI_NH_EVENT;
extern TraceEvent _TRACE_SMMUV3_CMDQ_TLBI_NH_ASID_EVENT;
extern TraceEvent _TRACE_SMMU_IOTLB_CACHE_HIT_EVENT;
extern TraceEvent _TRACE_SMMU_IOTLB_CACHE_MISS_EVENT;
...
extern uint16_t _TRACE_SMMUV3_CMDQ_TLBI_NH_VA_DSTATE;
extern uint16_t _TRACE_SMMUV3_CMDQ_TLBI_NH_VAA_DSTATE;
extern uint16_t _TRACE_SMMUV3_CMDQ_TLBI_NH_DSTATE;
extern uint16_t _TRACE_SMMUV3_CMDQ_TLBI_NH_ASID_DSTATE;
extern uint16_t _TRACE_SMMU_IOTLB_CACHE_HIT_DSTATE;
extern uint16_t _TRACE_SMMU_IOTLB_CACHE_MISS_DSTATE;
...
#define TRACE_SMMUV3_CMDQ_TLBI_NH_VA_ENABLED 1
#define TRACE_SMMUV3_CMDQ_TLBI_NH_VAA_ENABLED 1
#define TRACE_SMMUV3_CMDQ_TLBI_NH_ENABLED 1
#define TRACE_SMMUV3_CMDQ_TLBI_NH_ASID_ENABLED 1
#define TRACE_SMMU_IOTLB_CACHE_HIT_ENABLED 1
#define TRACE_SMMU_IOTLB_CACHE_MISS_ENABLED 1
...
static inline void _nocheck__trace_smmuv3_decode_cd_tt(int i, uint32_t tsz, uint64_t ttb, uint32_t granule_sz)
{
    if (trace_event_get_state(TRACE_SMMUV3_DECODE_CD_TT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmuv3_decode_cd_tt " "TT[%d]:tsz:%d ttb:0x%"PRIx64" granule_sz:%d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , i, tsz, ttb, granule_sz);
    }
}

static inline void trace_smmuv3_decode_cd_tt(int i, uint32_t tsz, uint64_t ttb, uint32_t granule_sz)
{
    if (true) {
        _nocheck__trace_smmuv3_decode_cd_tt(i, tsz, ttb, granule_sz);
    }
}
...
static inline void _nocheck__trace_smmuv3_cmdq_cfgi_ste_range(int start, int end)
{
    if (trace_event_get_state(TRACE_SMMUV3_CMDQ_CFGI_STE_RANGE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmuv3_cmdq_cfgi_ste_range " "start=0x%d - end=0x%d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , start, end);
    }
...
#define TRACE_SMMUV3_CMDQ_TLBI_NH_VA_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMUV3_CMDQ_TLBI_NH_VA) || \
    false)

static inline void _nocheck__trace_smmuv3_cmdq_tlbi_nh_va(int vmid, int asid, uint64_t addr, bool leaf)
{
    if (trace_event_get_state(TRACE_SMMUV3_CMDQ_TLBI_NH_VA) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmuv3_cmdq_tlbi_nh_va " "vmid =%d asid =%d addr=0x%"PRIx64" leaf=%d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , vmid, asid, addr, leaf);
    }
...
static inline void trace_smmuv3_cmdq_tlbi_nh_va(int vmid, int asid, uint64_t addr, bool leaf)
{
    if (true) {
        _nocheck__trace_smmuv3_cmdq_tlbi_nh_va(vmid, asid, addr, leaf);
    }
}

#define TRACE_SMMUV3_CMDQ_TLBI_NH_VAA_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMUV3_CMDQ_TLBI_NH_VAA) || \
    false)

static inline void _nocheck__trace_smmuv3_cmdq_tlbi_nh_vaa(int vmid, uint64_t addr)
{
    if (trace_event_get_state(TRACE_SMMUV3_CMDQ_TLBI_NH_VAA) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmuv3_cmdq_tlbi_nh_vaa " "vmid =%d addr=0x%"PRIx64 "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , vmid, addr);
    }
...
static inline void trace_smmuv3_cmdq_tlbi_nh_vaa(int vmid, uint64_t addr)
{
    if (true) {
        _nocheck__trace_smmuv3_cmdq_tlbi_nh_vaa(vmid, addr);
    }
}
...
#define TRACE_SMMU_IOTLB_CACHE_HIT_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMU_IOTLB_CACHE_HIT) || \
    false)

static inline void _nocheck__trace_smmu_iotlb_cache_hit(uint16_t asid, uint64_t addr, uint32_t hit, uint32_t miss, uint32_t p)
{
    if (trace_event_get_state(TRACE_SMMU_IOTLB_CACHE_HIT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmu_iotlb_cache_hit " "IOTLB cache HIT asid=%d addr=0x%"PRIx64" hit=%d miss=%d hit rate=%d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void trace_smmu_iotlb_cache_hit(uint16_t asid, uint64_t addr, uint32_t hit, uint32_t miss, uint32_t p)
{
    if (true) {
        _nocheck__trace_smmu_iotlb_cache_hit(asid, addr, hit, miss, p);
    }
}

#define TRACE_SMMU_IOTLB_CACHE_MISS_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SMMU_IOTLB_CACHE_MISS) || \
    false)

static inline void _nocheck__trace_smmu_iotlb_cache_miss(uint16_t asid, uint64_t addr, uint32_t hit, uint32_t miss, uint32_t p)
{
    if (trace_event_get_state(TRACE_SMMU_IOTLB_CACHE_MISS) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmu_iotlb_cache_miss " "IOTLB cache MISS asid=%d addr=0x%"PRIx64" hit=%d miss=%d hit rate=%d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , asid, addr, hit, miss, p);
    }
...
static inline void trace_smmu_iotlb_cache_miss(uint16_t asid, uint64_t addr, uint32_t hit, uint32_t miss, uint32_t p)
{
    if (true) {
        _nocheck__trace_smmu_iotlb_cache_miss(asid, addr, hit, miss, p);
    }
}
...
static inline void _nocheck__trace_smmuv3_inv_notifiers_iova(const char * name, uint16_t asid, uint64_t iova)
{
    if (trace_event_get_state(TRACE_SMMUV3_INV_NOTIFIERS_IOVA) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:smmuv3_inv_notifiers_iova " "iommu mr=%s asid=%d iova=0x%"PRIx64 "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , name, asid, iova);
    }
...
static inline void trace_smmuv3_inv_notifiers_iova(const char * name, uint16_t asid, uint64_t iova)
{
    if (true) {
        _nocheck__trace_smmuv3_inv_notifiers_iova(name, asid, iova);
    }
}
