...
#define TRACE_ADB_KBD_NO_KEY_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_ADB_KBD_NO_KEY) || \
    false)

static inline void _nocheck__trace_adb_kbd_no_key(void)
{
    if (trace_event_get_state(TRACE_ADB_KBD_NO_KEY) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:adb_kbd_no_key " "Ignoring NO_KEY" "\n",
                 qemu_get_thread_id(),
...
#define TRACE_ADB_KBD_WRITEREG_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_ADB_KBD_WRITEREG) || \
    false)

static inline void _nocheck__trace_adb_kbd_writereg(int reg, uint8_t val)
{
    if (trace_event_get_state(TRACE_ADB_KBD_WRITEREG) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:adb_kbd_writereg " "reg %d val 0x%2.2x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , reg, val);
    }
...
#define TRACE_ADB_KBD_READREG_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_ADB_KBD_READREG) || \
    false)

static inline void _nocheck__trace_adb_kbd_readreg(int reg, uint8_t val0, uint8_t val1)
{
    if (trace_event_get_state(TRACE_ADB_KBD_READREG) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:adb_kbd_readreg " "reg %d obuf[0] 0x%2.2x obuf[1] 0x%2.2x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , reg, val0, val1);
    }
...
#define TRACE_ADB_KBD_REQUEST_CHANGE_ADDR_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_ADB_KBD_REQUEST_CHANGE_ADDR) || \
    false)

static inline void _nocheck__trace_adb_kbd_request_change_addr(int devaddr)
{
    if (trace_event_get_state(TRACE_ADB_KBD_REQUEST_CHANGE_ADDR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:adb_kbd_request_change_addr " "change addr to 0x%x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , devaddr);
    }
...
#define TRACE_ADB_KBD_REQUEST_CHANGE_ADDR_AND_HANDLER_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_ADB_KBD_REQUEST_CHANGE_ADDR_AND_HANDLER) || \
    false)

static inline void _nocheck__trace_adb_kbd_request_change_addr_and_handler(int devaddr, int handler)
{
    if (trace_event_get_state(TRACE_ADB_KBD_REQUEST_CHANGE_ADDR_AND_HANDLER) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:adb_kbd_request_change_addr_and_handler " "change addr and handler to 0x%x, 0x%x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , devaddr, handler);
    }
...
#define TRACE_ADB_MOUSE_FLUSH_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_ADB_MOUSE_FLUSH) || \
    false)

static inline void _nocheck__trace_adb_mouse_flush(void)
{
    if (trace_event_get_state(TRACE_ADB_MOUSE_FLUSH) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:adb_mouse_flush " "flush" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
#define TRACE_ADB_MOUSE_WRITEREG_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_ADB_MOUSE_WRITEREG) || \
    false)

static inline void _nocheck__trace_adb_mouse_writereg(int reg, uint8_t val)
{
    if (trace_event_get_state(TRACE_ADB_MOUSE_WRITEREG) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:adb_mouse_writereg " "reg %d val 0x%2.2x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , reg, val);
    }
...
#define TRACE_ADB_MOUSE_READREG_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_ADB_MOUSE_READREG) || \
    false)

static inline void _nocheck__trace_adb_mouse_readreg(int reg, uint8_t val0, uint8_t val1)
{
    if (trace_event_get_state(TRACE_ADB_MOUSE_READREG) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:adb_mouse_readreg " "reg %d obuf[0] 0x%2.2x obuf[1] 0x%2.2x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , reg, val0, val1);
    }
...
#define TRACE_ADB_MOUSE_REQUEST_CHANGE_ADDR_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_ADB_MOUSE_REQUEST_CHANGE_ADDR) || \
    false)

static inline void _nocheck__trace_adb_mouse_request_change_addr(int devaddr)
{
    if (trace_event_get_state(TRACE_ADB_MOUSE_REQUEST_CHANGE_ADDR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:adb_mouse_request_change_addr " "change addr to 0x%x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , devaddr);
    }
...
#define TRACE_ADB_MOUSE_REQUEST_CHANGE_ADDR_AND_HANDLER_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_ADB_MOUSE_REQUEST_CHANGE_ADDR_AND_HANDLER) || \
    false)

static inline void _nocheck__trace_adb_mouse_request_change_addr_and_handler(int devaddr, int handler)
{
    if (trace_event_get_state(TRACE_ADB_MOUSE_REQUEST_CHANGE_ADDR_AND_HANDLER) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:adb_mouse_request_change_addr_and_handler " "change addr and handler to 0x%x, 0x%x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , devaddr, handler);
    }
