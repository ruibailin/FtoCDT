...
extern TraceEvent _TRACE_SERIAL_IOPORT_READ_EVENT;
extern TraceEvent _TRACE_SERIAL_IOPORT_WRITE_EVENT;
...
extern uint16_t _TRACE_SERIAL_IOPORT_READ_DSTATE;
extern uint16_t _TRACE_SERIAL_IOPORT_WRITE_DSTATE;
...
#define TRACE_SERIAL_IOPORT_READ_ENABLED 1
#define TRACE_SERIAL_IOPORT_WRITE_ENABLED 1
...
#define TRACE_SERIAL_IOPORT_READ_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SERIAL_IOPORT_READ) || \
    false)

static inline void _nocheck__trace_serial_ioport_read(uint16_t addr, uint8_t value)
{
    if (trace_event_get_state(TRACE_SERIAL_IOPORT_READ) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:serial_ioport_read " "read addr 0x%02x val 0x%02x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , addr, value);
    }
...
static inline void trace_serial_ioport_read(uint16_t addr, uint8_t value)
{
    if (true) {
        _nocheck__trace_serial_ioport_read(addr, value);
    }
}

#define TRACE_SERIAL_IOPORT_WRITE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_SERIAL_IOPORT_WRITE) || \
    false)

static inline void _nocheck__trace_serial_ioport_write(uint16_t addr, uint8_t value)
{
    if (trace_event_get_state(TRACE_SERIAL_IOPORT_WRITE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:serial_ioport_write " "write addr 0x%02x val 0x%02x" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , addr, value);
    }
...
static inline void trace_serial_ioport_write(uint16_t addr, uint8_t value)
{
    if (true) {
        _nocheck__trace_serial_ioport_write(addr, value);
    }
}
