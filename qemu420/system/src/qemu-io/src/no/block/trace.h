...
extern TraceEvent _TRACE_BLOCK_COPY_SKIP_EVENT;
...
extern TraceEvent _TRACE_NBD_CLIENT_CONNECT_EVENT;
extern TraceEvent _TRACE_NBD_CLIENT_CONNECT_SUCCESS_EVENT;
...
extern uint16_t _TRACE_BLOCK_COPY_SKIP_DSTATE;
...
extern uint16_t _TRACE_NBD_CLIENT_CONNECT_DSTATE;
extern uint16_t _TRACE_NBD_CLIENT_CONNECT_SUCCESS_DSTATE;
...
#define TRACE_BLOCK_COPY_SKIP_ENABLED 1
...
#define TRACE_NBD_CLIENT_CONNECT_ENABLED 1
#define TRACE_NBD_CLIENT_CONNECT_SUCCESS_ENABLED 1
...
#define TRACE_BLOCK_COPY_SKIP_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_BLOCK_COPY_SKIP) || \
    false)

static inline void _nocheck__trace_block_copy_skip(void * bcs, int64_t start)
{
    if (trace_event_get_state(TRACE_BLOCK_COPY_SKIP) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:block_copy_skip " "bcs %p start %"PRId64 "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , bcs, start);
    }
...
static inline void trace_block_copy_skip(void * bcs, int64_t start)
{
    if (true) {
        _nocheck__trace_block_copy_skip(bcs, start);
    }
}
...
static inline void _nocheck__trace_qcow2_add_task(void * co, void * bs, void * pool, const char * action, int cluster_type, uint64_t file_cluster_offset, uint64_t offset, uint64_t bytes, void * qiov, size_t qiov_offset)
{
    if (trace_event_get_state(TRACE_QCOW2_ADD_TASK) && qemu_loglevel_mask(LOG_TRACE)) {
        ...
        qemu_log("%d@%zu.%06zu:qcow2_add_task " "co %p bs %p pool %p: %s: cluster_type %d file_cluster_offset %" PRIu64 " offset %" PRIu64 " bytes %" PRIu64 " qiov %p qiov_offset %zu" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , co, bs, pool, action, cluster_type, file_cluster_offset, offset, bytes, qiov, qiov_offset);
    }
}

static inline void trace_qcow2_add_task(void * co, void * bs, void * pool, const char * action, int cluster_type, uint64_t file_cluster_offset, uint64_t offset, uint64_t bytes, void * qiov, size_t qiov_offset)
{
    if (true) {
        _nocheck__trace_qcow2_add_task(co, bs, pool, action, cluster_type, file_cluster_offset, offset, bytes, qiov, qiov_offset);
    }
}
...
static inline void _nocheck__trace_nvme_write_zeroes(void * s, uint64_t offset, uint64_t bytes, int flags)
{
    if (trace_event_get_state(TRACE_NVME_WRITE_ZEROES) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_write_zeroes " "s %p offset %"PRId64" bytes %"PRId64" flags %d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_nvme_dsm(void * s, uint64_t offset, uint64_t bytes)
{
    if (trace_event_get_state(TRACE_NVME_DSM) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_dsm " "s %p offset %"PRId64" bytes %"PRId64"" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , s, offset, bytes);
    }
...
static inline void _nocheck__trace_nvme_dsm_done(void * s, uint64_t offset, uint64_t bytes, int ret)
{
    if (trace_event_get_state(TRACE_NVME_DSM_DONE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvme_dsm_done " "s %p offset %"PRId64" bytes %"PRId64" ret %d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , s, offset, bytes, ret);
    }
...
#define TRACE_NBD_CLIENT_CONNECT_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NBD_CLIENT_CONNECT) || \
    false)

static inline void _nocheck__trace_nbd_client_connect(const char * export_name)
{
    if (trace_event_get_state(TRACE_NBD_CLIENT_CONNECT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_client_connect " "export '%s'" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , export_name);
    }
...
static inline void trace_nbd_client_connect(const char * export_name)
{
    if (true) {
        _nocheck__trace_nbd_client_connect(export_name);
    }
}

#define TRACE_NBD_CLIENT_CONNECT_SUCCESS_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_NBD_CLIENT_CONNECT_SUCCESS) || \
    false)

static inline void _nocheck__trace_nbd_client_connect_success(const char * export_name)
{
    if (trace_event_get_state(TRACE_NBD_CLIENT_CONNECT_SUCCESS) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nbd_client_connect_success " "export '%s'" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , export_name);
    }
...
static inline void trace_nbd_client_connect_success(const char * export_name)
{
    if (true) {
        _nocheck__trace_nbd_client_connect_success(export_name);
    }
}
