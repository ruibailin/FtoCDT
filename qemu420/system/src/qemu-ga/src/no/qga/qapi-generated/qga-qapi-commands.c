...
static void qmp_marshal_output_GuestHostName(GuestHostName *ret_in, QObject **ret_out, Error **errp)
{
    Error *err = NULL;
    Visitor *v;

    v = qobject_output_visitor_new(ret_out);
    visit_type_GuestHostName(v, "unused", &ret_in, &err);
    if (!err) {
        visit_complete(v, ret_out);
    }
    error_propagate(errp, err);
...
void qmp_marshal_guest_get_host_name(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_marshal_output_GuestHostName(retval, ret, &err);
...
static void qmp_marshal_output_GuestUserList(GuestUserList *ret_in, QObject **ret_out, Error **errp)
{
    Error *err = NULL;
    Visitor *v;

    v = qobject_output_visitor_new(ret_out);
    visit_type_GuestUserList(v, "unused", &ret_in, &err);
    if (!err) {
        visit_complete(v, ret_out);
    }
    error_propagate(errp, err);
...
void qmp_marshal_guest_get_users(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_marshal_output_GuestUserList(retval, ret, &err);
...
static void qmp_marshal_output_GuestTimezone(GuestTimezone *ret_in, QObject **ret_out, Error **errp)
{
    Error *err = NULL;
    Visitor *v;

    v = qobject_output_visitor_new(ret_out);
    visit_type_GuestTimezone(v, "unused", &ret_in, &err);
    if (!err) {
        visit_complete(v, ret_out);
    }
    error_propagate(errp, err);
...
void qmp_marshal_guest_get_timezone(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_marshal_output_GuestTimezone(retval, ret, &err);
...
static void qmp_marshal_output_GuestOSInfo(GuestOSInfo *ret_in, QObject **ret_out, Error **errp)
{
    Error *err = NULL;
    Visitor *v;

    v = qobject_output_visitor_new(ret_out);
    visit_type_GuestOSInfo(v, "unused", &ret_in, &err);
    if (!err) {
        visit_complete(v, ret_out);
    }
    error_propagate(errp, err);
...
void qmp_marshal_guest_get_osinfo(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_marshal_output_GuestOSInfo(retval, ret, &err);
