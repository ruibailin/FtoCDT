...
extern TraceEvent _TRACE_BCM2835_SYSTMR_IRQ_EVENT;
...
extern uint16_t _TRACE_BCM2835_SYSTMR_IRQ_DSTATE;
...
#define TRACE_BCM2835_SYSTMR_IRQ_ENABLED 1
...
#define TRACE_BCM2835_SYSTMR_IRQ_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_BCM2835_SYSTMR_IRQ) || \
    false)

static inline void _nocheck__trace_bcm2835_systmr_irq(bool enable)
{
    if (trace_event_get_state(TRACE_BCM2835_SYSTMR_IRQ) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:bcm2835_systmr_irq " "timer irq state %u" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , enable);
    }
...
static inline void trace_bcm2835_systmr_irq(bool enable)
{
    if (true) {
        _nocheck__trace_bcm2835_systmr_irq(enable);
    }
}
...
static inline void _nocheck__trace_bcm2835_systmr_write(uint64_t offset, uint64_t data)
{
    if (trace_event_get_state(TRACE_BCM2835_SYSTMR_WRITE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:bcm2835_systmr_write " "timer write: offset 0x%" PRIx64 " data 0x%" PRIx64 "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , offset, data);
    }
...
static inline void trace_bcm2835_systmr_write(uint64_t offset, uint64_t data)
{
    if (true) {
