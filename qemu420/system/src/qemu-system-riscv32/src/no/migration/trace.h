...
extern TraceEvent _TRACE_MULTIFD_SAVE_SETUP_WAIT_EVENT;
...
extern TraceEvent _TRACE_MIGRATION_THREAD_RATELIMIT_PRE_EVENT;
extern TraceEvent _TRACE_MIGRATION_THREAD_RATELIMIT_POST_EVENT;
...
extern uint16_t _TRACE_MULTIFD_SAVE_SETUP_WAIT_DSTATE;
...
extern uint16_t _TRACE_MIGRATION_THREAD_RATELIMIT_PRE_DSTATE;
extern uint16_t _TRACE_MIGRATION_THREAD_RATELIMIT_POST_DSTATE;
...
#define TRACE_MULTIFD_SAVE_SETUP_WAIT_ENABLED 1
...
#define TRACE_MIGRATION_THREAD_RATELIMIT_PRE_ENABLED 1
#define TRACE_MIGRATION_THREAD_RATELIMIT_POST_ENABLED 1
...
#define TRACE_MULTIFD_SAVE_SETUP_WAIT_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_MULTIFD_SAVE_SETUP_WAIT) || \
    false)

static inline void _nocheck__trace_multifd_save_setup_wait(uint8_t id)
{
    if (trace_event_get_state(TRACE_MULTIFD_SAVE_SETUP_WAIT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:multifd_save_setup_wait " "%d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , id);
    }
...
static inline void trace_multifd_save_setup_wait(uint8_t id)
{
    if (true) {
        _nocheck__trace_multifd_save_setup_wait(id);
    }
}
...
#define TRACE_MIGRATION_THREAD_RATELIMIT_PRE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_MIGRATION_THREAD_RATELIMIT_PRE) || \
    false)

static inline void _nocheck__trace_migration_thread_ratelimit_pre(int ms)
{
    if (trace_event_get_state(TRACE_MIGRATION_THREAD_RATELIMIT_PRE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:migration_thread_ratelimit_pre " "%d ms" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , ms);
    }
...
static inline void trace_migration_thread_ratelimit_pre(int ms)
{
    if (true) {
        _nocheck__trace_migration_thread_ratelimit_pre(ms);
    }
}

#define TRACE_MIGRATION_THREAD_RATELIMIT_POST_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_MIGRATION_THREAD_RATELIMIT_POST) || \
    false)

static inline void _nocheck__trace_migration_thread_ratelimit_post(int urgent)
{
    if (trace_event_get_state(TRACE_MIGRATION_THREAD_RATELIMIT_POST) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:migration_thread_ratelimit_post " "urgent: %d" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , urgent);
    }
...
static inline void trace_migration_thread_ratelimit_post(int urgent)
{
    if (true) {
        _nocheck__trace_migration_thread_ratelimit_post(urgent);
    }
}
