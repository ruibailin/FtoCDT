...
VL_INLINE_OPT void VTestHarness___024unit::__Vdpiimwrap_memory_init_TOP____024unit(QData/*63:0*/ mem_size, QData/*63:0*/ word_size, QData/*63:0*/ line_size, QData/*63:0*/ id_bits, QData/*63:0*/ (&memory_init__Vfuncrtn)) {
    ...
    memory_init__Vfuncrtn__Vcvt = memory_init(mem_size__Vcvt, word_size__Vcvt, line_size__Vcvt, id_bits__Vcvt);
...
VL_INLINE_OPT void VTestHarness___024unit::__Vdpiimwrap_serial_tick_TOP____024unit(CData/*0:0*/ serial_out_valid, CData/*0:0*/ (&serial_out_ready), IData/*31:0*/ serial_out_bits, CData/*0:0*/ (&serial_in_valid), CData/*0:0*/ serial_in_ready, IData/*31:0*/ (&serial_in_bits), IData/*31:0*/ (&serial_tick__Vfuncrtn)) {
...
VL_INLINE_OPT void VTestHarness___024unit::__Vdpiimwrap_uart_init_TOP____024unit(std::string filename, IData/*31:0*/ uartno) {
...
VL_INLINE_OPT void VTestHarness___024unit::__Vdpiimwrap_uart_tick_TOP____024unit(CData/*0:0*/ serial_out_valid, CData/*0:0*/ (&serial_out_ready), CData/*7:0*/ serial_out_bits, CData/*0:0*/ (&serial_in_valid), CData/*0:0*/ serial_in_ready, CData/*7:0*/ (&serial_in_bits)) {
