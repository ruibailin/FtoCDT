...
void VTestHarness::_initial__TOP__1(VTestHarness__Syms* __restrict vlSymsp) {
    ...
    if ((! VL_VALUEPLUSARGS_INI(32, VL_CVT_PACK_STR_NW(5, __Vtemp8), 
        ...
        vlTOPp->TestHarness__DOT__dut__DOT__system__DOT__subsystem_sbus__DOT__coupler_from_tile__DOT__buffer__DOT__TLMonitor__DOT__plusarg_reader__DOT__myplus = 0U;
    }
...
void VTestHarness::_initial__TOP__5(VTestHarness__Syms* __restrict vlSymsp) {
    ...
    if ((! VL_VALUEPLUSARGS_INI(32, VL_CVT_PACK_STR_NW(5, __Vtemp51), 
        ...
        vlTOPp->TestHarness__DOT__dut__DOT__system__DOT__tile__DOT__tlMasterXbar__DOT__TLMonitor__DOT__plusarg_reader__DOT__myplus = 0U;
    }
    ...
    if ((! VL_VALUEPLUSARGS_INI(32, VL_CVT_PACK_STR_NW(5, __Vtemp52), 
        ...
        vlTOPp->TestHarness__DOT__dut__DOT__system__DOT__tile__DOT__tlMasterXbar__DOT__TLMonitor_1__DOT__plusarg_reader__DOT__myplus = 0U;
    }
    ...
    if ((! VL_VALUEPLUSARGS_INI(32, VL_CVT_PACK_STR_NW(5, __Vtemp53), 
        ...
        vlTOPp->TestHarness__DOT__dut__DOT__system__DOT__tile__DOT__buffer__DOT__TLMonitor__DOT__plusarg_reader__DOT__myplus = 0U;
    }
    ...
    __Vtemp58[0U] = 0x733d2564U;
    __Vtemp58[1U] = 0x79636c65U;
    __Vtemp58[2U] = 0x72655f63U;
    __Vtemp58[3U] = 0x785f636fU;
    __Vtemp58[4U] = 0x6d61U;
    if ((! VL_VALUEPLUSARGS_INI(32, VL_CVT_PACK_STR_NW(5, __Vtemp58), 
        ...
        vlTOPp->TestHarness__DOT__dut__DOT__system__DOT__tile__DOT__core__DOT__PlusArgTimeout__DOT__plusarg_reader__DOT__myplus = 0U;
    }
    vlTOPp->TestHarness__DOT__SimDRAM__DOT__initialized = 0U;
    __Vtemp59[0U] = 0x673d2573U;
    __Vtemp59[1U] = 0x72746c6fU;
    __Vtemp59[2U] = 0x7561U;
    (void)VL_VALUEPLUSARGS_INN(64, VL_CVT_PACK_STR_NW(3, __Vtemp59), 
