...
struct qt_meta_stringdata_TerminalView_t {
    QByteArrayData data[4];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TerminalView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TerminalView_t qt_meta_stringdata_TerminalView = {
    {
QT_MOC_LITERAL(0, 0, 12), // "TerminalView"
QT_MOC_LITERAL(1, 13, 17), // "onCharTransmitted"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 1) // "c"

    },
    "TerminalView\0onCharTransmitted\0\0c"
};
...
void TerminalView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onCharTransmitted((*reinterpret_cast< char(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject TerminalView::staticMetaObject = {
    { &QPlainTextEdit::staticMetaObject, qt_meta_stringdata_TerminalView.data,
      qt_meta_data_TerminalView,  qt_static_metacall, nullptr, nullptr}
};
...
void *TerminalView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TerminalView.stringdata0))
