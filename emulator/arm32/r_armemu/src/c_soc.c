...
#if 1
const char *cfg_file_name="//home/steve/code/code/emulator/arm32/r_armemu/src/armemu.conf";
const char *elf_bin_name="/home/steve/code/code/emulator/arm32/r_armemu/src/test.bin";
const char *blk_dev_name="/home/steve/code/code/emulator/arm32/r_armemu/src/bdev.bin";
#else
